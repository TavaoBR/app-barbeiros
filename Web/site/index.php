<?=$this->layout('themes/site', ['title' => $title]);?>
    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Sobre</h2>
          <h3>Leia mais <span>Sobre nossa clinica</span></h3>
          <p>Um novo conceito de clínica Integrativa trazendo qualidade e excelência na cidade de Estância/SE</p>
        </div>

        <div class="row">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <img src="<?=Assests("img")?>/site/clinica.jpg" class="img-fluid" alt="">
          </div>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Serviços</h2>
          <h3>Veja nosso <span>Serviços</span></h3>
        </div>
