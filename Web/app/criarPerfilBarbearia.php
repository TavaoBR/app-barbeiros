...
<div class="container">
    <div class="main-body">
          ...
          <div class="row gutters-sm">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="" id="imagePreview" alt="Admin" class="rounded-circle" width="150">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-8">
            <?=validateSession("CriarPerfilBarbearia")?>
            <form method="POST" action="<?=routerConfig()?>/criar/perfil/barbearia" id="confirmationForm" enctype="multipart/form-data">
              ...
              <div class="card mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Logo Barbearia</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
