...
<div class="row">
		<div class="col-12">
			...
			<!-- Form START -->
			<form class="file-upload" id="confirmationForm" action="<?=routerConfig()?>/profissional/cadastrar/<?=$id?>" method="POST" enctype="multipart/form-data">
				<div class="row mb-5 gx-5">
					<!-- Contact detail -->
					<div class="col-xxl-8 mb-5 mb-xxl-0">
                        <?=validateSession("CadastroPro")?>
